...
class JobCategory
{
    ...
    #[ORM\OneToMany(mappedBy: 'jobCategory', targetEntity: JobOffer::class, orphanRemoval: true)]
    private Collection $jobOffers;

    #[ORM\OneToMany(mappedBy: 'jobCategory', targetEntity: Candidate::class, orphanRemoval: true)]
